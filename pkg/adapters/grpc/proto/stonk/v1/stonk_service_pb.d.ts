...
export class GetStonkResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: GetStonkResponse
  ): GetStonkResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class GainersRequest extends jspb.Message {
  getNull(): string;
  setNull(value: string): GainersRequest;
...
export class LoosersRequest extends jspb.Message {
  getNull(): string;
  setNull(value: string): LoosersRequest;
...
export class CompareRequest extends jspb.Message {
  getNull(): string;
  setNull(value: string): CompareRequest;
